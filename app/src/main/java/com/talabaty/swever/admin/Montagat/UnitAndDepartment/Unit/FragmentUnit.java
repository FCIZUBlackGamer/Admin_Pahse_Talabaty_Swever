package com.talabaty.swever.admin.Montagat.UnitAndDepartment.Unit;
...
public class FragmentUnit extends Fragment {
    ...
    List<Item> items;
    private String UPLOAD_LINK = "http://sellsapi.rivile.com/Units/AddUnits";
    Button save, done;
    EditText name;
    ...
    public static FragmentUnit setData(Item x) {
        FragmentUnit c = new FragmentUnit();
        c.montagModel = x;
        return c;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_add_unit, container, false);
    ...
    public void onStart() {
        ...
        if (montagModel != null) {
            try {
                ((Home) getActivity())
                        .setActionBarTitle("تعديل وحدة");
            }catch (Exception e){
                ((Mabi3atNavigator) getActivity())
                        .setActionBarTitle("تعديل وحدة");
            }
            name.setText(montagModel.getName());
            UPLOAD_LINK = "http://sellsapi.rivile.com/Units/EditUnits";
            save.setText("تعديل");
