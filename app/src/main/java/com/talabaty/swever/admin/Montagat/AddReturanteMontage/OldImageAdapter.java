...
public class OldImageAdapter extends RecyclerView.Adapter<OldImageAdapter.Vholder> {
    ...
    Context context;
    List<com.talabaty.swever.admin.Montagat.AddReturanteMontage.ImageSource> imageSources;

    public OldImageAdapter(Context context, List<com.talabaty.swever.admin.Montagat.AddReturanteMontage.ImageSource> imageSources) {
